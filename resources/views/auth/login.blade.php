...
<html lang="en">
  ...
  <body style="height: 100vh; overflow-x:hidden">
    <div class="row">
        <div class="col">
            <div class="text-center px-5" style="margin-top: 20%">
                <p class="fw-bold px-5"><i class="bi bi-bag-check-fill me-2"></i>SIMS Web App</p>
                <h3 class="px-5 mb-5">Masuk atau buat akun untuk memulai</h3>
                <form action="{{ route('login.store') }}" method="POST" class="w-100 px-5">
                    @csrf
                    <div class="mb-3">
                    ...
                    <p class="text-center">No Have Account? <a href="{{ route('register') }}">Register</a></p>
                </form>
            </div>
        </div>
